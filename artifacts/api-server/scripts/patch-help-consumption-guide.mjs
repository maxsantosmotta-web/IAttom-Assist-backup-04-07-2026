...
— Gerar Vídeo com Efeito: consome 1 unidade de vídeo por geração iniciada de acordo com a regra comercial do pacote de vídeos.
...
console.log("IAttom Help consumption guide applied.");
