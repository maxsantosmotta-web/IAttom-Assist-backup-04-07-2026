...
import adminAnalyticsCanonicalRouter from "./adminAnalyticsCanonical.js";
...
import googlePlaySubscriptionEntitlementsRouter from "./googlePlaySubscriptionEntitlements.js";
...
// Precisa vir antes de qualquer roteador legado que também responda /admin/analytics.
router.use(adminAnalyticsCanonicalRouter);
...
router.use(googlePlaySubscriptionEntitlementsRouter);
