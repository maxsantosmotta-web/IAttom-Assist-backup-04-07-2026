...
if (source.includes('Label className="text-sm text-muted-foreground block mb-3">Tipo de criativo</Label>')) {
  throw new Error("Creative type selector is still visible");
}
