...
const annualBlock = `      <Card className="relative overflow-hidden border-white/[0.07] bg-[#0d1015] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,.025),0_18px_45px_rgba(0,0,0,.22)]">
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs text-zinc-600">Assinaturas ativas com cobrança recorrente anual no Stripe.</p>
        </div>
...
console.log("Admin Finance now renders a separate annual plans block without changing any billing operation.");
