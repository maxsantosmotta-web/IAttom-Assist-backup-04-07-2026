...
export function UpgradeNudge({ totalActions = 0 }: UpgradeNudgeProps) {
  ...
  const configs = {
    critical: {
      ...
      body: `Only ${creditsLeft} credits remaining. Upgrade now to keep working without interruption.`,
      cta: "Upgrade now",
      accentCta: true,
    },
    low: {
      ...
      title: `Running low — ${pct}% credits remaining`,
      body: `You have ${creditsLeft} credits left this month. Upgrade for ${PLAN_CREDITS.pro.toLocaleString()}+ credits and priority access.`,
      cta: "View plans",
      accentCta: false,
    },
    power: {
