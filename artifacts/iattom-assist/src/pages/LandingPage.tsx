...
import { UserPlus, LogIn, X, Chrome } from "lucide-react";
      ...
      <div className="fixed inset-0 z-50 flex flex-col justify-end">
        ...
        >
          ...
          <div className="px-6 pt-4 pb-10">
            ...
            {/* subtitle */}
            <p className="text-[12px] text-white/45 mb-6 tracking-wide">
              Sua vantagem com IA começa aqui.
            </p>
            ...
            >
              <Chrome className="w-[17px] h-[17px]" />
