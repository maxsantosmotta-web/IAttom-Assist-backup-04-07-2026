...
import {
  Facebook as FacebookIcon, Loader2, ExternalLink, RefreshCw,
  Globe, Megaphone, ClipboardList, FolderOpen,
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground/70">
                  Abra o Facebook Ads Manager e publique utilizando os materiais criados no IAttom.
                </p>
              </div>
            </div>
          </CardContent>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Publicações e páginas</p>
                  </div>
                </div>
              </CardHeader>
