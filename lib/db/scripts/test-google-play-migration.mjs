...
const migrationPath = new URL("../drizzle/0001_google_play_purchases.sql", import.meta.url);
...
try {
  ...
  await client.query("SAVEPOINT duplicate_event_key_test");
  try {
    await client.query(`
      INSERT INTO google_play_purchases (
        event_key,
    ...
    await client.query("ROLLBACK TO SAVEPOINT duplicate_event_key_test");
    if (error?.code === "23505") uniqueConstraintWorked = true;
    else throw error;
  }
  await client.query("RELEASE SAVEPOINT duplicate_event_key_test");
