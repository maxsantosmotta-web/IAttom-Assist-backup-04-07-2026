...
for (const [fragment, label] of [
  ...
  ['basePlanId: "start-mensal"', "start_monthly_base_plan"],
  ['billingPeriod: "monthly"', "monthly_billing_period"],
  ['iattom_start_anual:', "iattom_start_anual"],
  ['basePlanId: "start-anual"', "start_annual_base_plan"],
  ['billingPeriod: "annual"', "annual_billing_period"],
  ['internalPlan: "pro"', "start_internal_plan"],
  ['monthlyCredits: 200', "start_monthly_credits"],
  ['iattom_premium:', "iattom_premium"],
  ['basePlanId: "premium-mensal"', "premium_monthly_base_plan"],
  ['iattom_premium_anual:', "iattom_premium_anual"],
  ['basePlanId: "premium-anual"', "premium_annual_base_plan"],
  ['internalPlan: "business"', "premium_internal_plan"],
  ['monthlyCredits: 500', "premium_monthly_credits"],
  ['iattom_pro:', "iattom_pro"],
  ['basePlanId: "pro-mensal"', "pro_monthly_base_plan"],
  ['iattom_pro_anual:', "iattom_pro_anual"],
  ['basePlanId: "pro-anual"', "pro_annual_base_plan"],
...
try {
  ...
  // START mensal e anual usam SKUs separados.
  ...
  assertEqual(await grantSubscription({ userId: "user-a", token: "start-annual-token", period: "order-start-a-1", productId: "iattom_start_anual", basePlanId: "start-anual", plan: "pro", amount: 2400 }), true, "start_annual_first");

  // PREMIUM e PRO mensal/anual também usam SKUs separados.
  ...
  assertEqual(await grantSubscription({ userId: "user-a", token: "premium-annual-token", period: "order-premium-a-1", productId: "iattom_premium_anual", basePlanId: "premium-anual", plan: "business", amount: 6000 }), true, "premium_annual_first");
  ...
  assertEqual(await grantSubscription({ userId: "user-a", token: "pro-annual-token", period: "order-pro-a-1", productId: "iattom_pro_anual", basePlanId: "pro-anual", plan: "agency", amount: 12000 }), true, "pro_annual_first");
